...
set(MSG_I_FLAGS "-Iplanner_manager:/home/barr1yuan/workspaces/3D2M_ws/src/3D2M-planner/planner/src/planner_manager/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg;-Igeometry_msgs:/opt/ros/noetic/share/geometry_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/barr1yuan/workspaces/3D2M_ws/src/3D2M-planner/planner/src/planner_manager/msg/Polynome.msg" NAME_WE)
add_custom_target(_planner_manager_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "planner_manager" "/home/barr1yuan/workspaces/3D2M_ws/src/3D2M-planner/planner/src/planner_manager/msg/Polynome.msg" "geometry_msgs/Vector3:geometry_msgs/Point"
)

get_filename_component(_filename "/home/barr1yuan/workspaces/3D2M_ws/src/3D2M-planner/planner/src/planner_manager/msg/DVHcontrol.msg" NAME_WE)
add_custom_target(_planner_manager_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "planner_manager" "/home/barr1yuan/workspaces/3D2M_ws/src/3D2M-planner/planner/src/planner_manager/msg/DVHcontrol.msg" "std_msgs/Header"
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/planner_manager)
  install(CODE "execute_process(COMMAND \"/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/planner_manager\")")
  # install generated code
  install(
