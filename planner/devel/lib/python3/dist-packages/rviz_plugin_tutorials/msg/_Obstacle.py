...
"""autogenerated by genpy from rviz_plugin_tutorials/Obstacle.msg. Do not edit."""
import codecs
import sys
...
import rviz_plugin_tutorials.msg
import std_msgs.msg

class Obstacle(genpy.Message):
  _md5sum = "a35813c504459c3d380dd3d750825e9e"
  _type = "rviz_plugin_tutorials/Obstacle"
...
float64 z"""
  ...
  _slot_types = ['std_msgs/Header','rviz_plugin_tutorials/ObstaclePose[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = rviz_plugin_tutorials.msg.ObstaclePose()
        _v6 = val1.header
        start = end
        end += 4
